...
const char* serverName = "http://52.90.154.36:8080/setValue";
...
void loop() {
  ...
  if(current_time - PastTime >= timerDelay) {
  Serial.println("=================================");
  ...
  deadtime = finish_time - current_time;
  PastTime = current_time;
  Serial.print("Delay Time="); Serial.println(deadtime);
